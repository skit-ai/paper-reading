...
** /future/
- Zhang, X., Manohar, V., Povey, D., & Khudanpur, S., [[https://arxiv.org/abs/1706.03747][Acoustic data-driven lexicon learning based on a greedy pronunciation selection framework]], arXiv preprint arXiv:1706.03747, (),  (2017). (cite:zhang2017acoustic)

- Arjovsky, M., Bottou, L., Gulrajani, I., & Lopez-Paz, D., [[https://arxiv.org/pdf/1907.02893.pdf][Invariant Risk Minimization]] (2019). (cite:arjovsky2019invariant)

- Christiano, P., Shlegeris, B., & Amodei, D., [[https://arxiv.org/abs/1810.08575][Supervising strong learners by amplifying weak experts]], arXiv preprint arXiv:1810.08575, (),  (2018). (cite:christiano2018supervising)

- Chen, X., Hassan, A., Hassan, H., Wang, W., & Cardie, C., [[https://arxiv.org/pdf/1810.03552.pdf][Multi-source cross-lingual model transfer: learning what to share]], In , Proceedings of the 57th Conference of the Association for Computational Linguistics (pp. 3098–3112) (2019). : . (cite:chen2019multi)

- Tukey, J. W., [[https://projecteuclid.org/euclid.aoms/1177704711][The future of data analysis]], The annals of mathematical statistics, 33(1), 1–67 (1962). (cite:tukey1962future)
